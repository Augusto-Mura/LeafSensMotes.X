...
void timerTick(void);
void timerHandler16(void);
void timerTick16(void);
...
GPIODigitalWrite(0xFF, 1);

rn2483_delaysec(1);
acquisitionData(0x03, stringValue);
stringValueLength = adaptString(stringValue, 5);
...
void leafSensAcquisition(void){
acquisitionData(0x01, stringValue);
stringValueLength = adaptString(stringValue, 5);
