...
# 1 "mcc_generated_files/LoRaWAN/radio_driver_SX1276.c"
...
# 117 "mcc_generated_files/LoRaWAN/../spi2.h"
...
# 204 "mcc_generated_files/LoRaWAN/../pin_manager.h"
...
# 55 "mcc_generated_files/LoRaWAN/radio_driver_hal.h"
...
# 57 "mcc_generated_files/LoRaWAN/lorawan_radio.h"
...
# 54 "mcc_generated_files/LoRaWAN/radio_driver_SX1276.c"
typedef enum
{
MODE_SLEEP = 0,
MODE_STANDBY,
...
opMode = RADIO_RegisterRead(0x01);
...
RADIO_RegisterWrite(0x01, opMode & (~0x07));
...
RADIO_RegisterWrite(0x01, opMode);
}
...
{
dioMapping = RADIO_RegisterRead(0x41);
if (MODULATION_FSK == newModulation)
{
...
RADIO_RegisterWrite(0x41, dioMapping);
}
...
RADIO_RegisterWrite(0x06, (num >> (16)) & 0xFF);
RADIO_RegisterWrite(0x07, (num >> (8)) & 0xFF);
RADIO_RegisterWrite(0x08, num & 0xFF);
}
...
RADIO_RegisterWrite(0x04, (num >> (8)) & 0xFF);
RADIO_RegisterWrite(0x05, num & 0xFF);
}
...
RADIO_RegisterWrite(0x02, (num >> (8)) & 0xFF);
RADIO_RegisterWrite(0x03, num & 0xFF);
RADIO_RegisterWrite(0x5D, 0x00);
}
...
paDac = RADIO_RegisterRead(0x4D);
paDac &= ~(0x07);
paDac |= 0x04;
RADIO_RegisterWrite(0x4D, paDac);
...
power += 3;
RADIO_RegisterWrite(0x09, 0x20 | power);
}
else
{
...
RADIO_RegisterWrite(0x09, 0x70 | power);
}
}
else
{
...
RADIO_RegisterWrite(0x4D, paDac);
RADIO_RegisterWrite(0x09, 0x80 | power);
RADIO_RegisterWrite(0x0B, ocp);
}
}
...
RadioConfiguration.watchdogTimerTimeout = ((uint32_t)15000);
...
RadioConfiguration.fhssNextFrequency = (0);
...
RADIO_RegisterWrite(0x3B, 0x42);


while ((RADIO_RegisterRead(0x3B) & 0x20) != 0)
;


RADIO_RegisterWrite(0x0C, 0x23);


RADIO_RegisterWrite(0x0D, 0x1E);



RADIO_RegisterWrite(0x1F, 0xAA);



RADIO_RegisterWrite(0x35, 0x8F);


RADIO_RegisterWrite(0x32, 0xFF);


RADIO_RegisterWrite(0x31, 1 << (6));
...
RADIO_RegisterWrite(0x23, 0xFF);

RadioConfiguration.regVersion = RADIO_RegisterRead(0x42);
}
...
RADIO_RegisterWrite(0x1D,
(RadioConfiguration.bandWidth << (4)) |
(RadioConfiguration.errorCodingRate << (1)) |
(RadioConfiguration.implicitHeaderMode & 0x01));

RADIO_RegisterWrite(0x1E,
(RadioConfiguration.dataRate << (4)) |
((RadioConfiguration.crcOn & 0x01) << (2)) |
((symbolTimeout & 0x0300) >> (8)));
...
RADIO_RegisterWrite(0x24, (uint8_t)tempValue);

RADIO_RegisterWrite(0x1F, (symbolTimeout & 0xFF));

# 595
regValue = RADIO_RegisterRead(0x26);
if (
(
...
regValue |= 1 << (2);
RADIO_RegisterWrite(0x26, regValue);
...
regValue &= ~(1 << (6));
regValue |= (1 << (0));
regValue |= (RadioConfiguration.iqInverted & 0x01) << (6);
RADIO_RegisterWrite(0x33, regValue);

regValue = 0x1D & (~((RadioConfiguration.iqInverted & 0x01) << (2)));
RADIO_RegisterWrite(0x3B, regValue);

RADIO_RegisterWrite(0x20, RadioConfiguration.preambleLen >> (8));
RADIO_RegisterWrite(0x21, RadioConfiguration.preambleLen & 0xFF);

RADIO_RegisterWrite(0x0D, 0x00);
RADIO_RegisterWrite(0x0E, 0x00);
RADIO_RegisterWrite(0x0F, 0x00);


if (0x12 == RadioConfiguration.regVersion)
{
if ( (BW_500KHZ == RadioConfiguration.bandWidth) &&
(RadioConfiguration.frequency >= 862000000) &&
(RadioConfiguration.frequency <= 1020000000)
)
{
...
(RadioConfiguration.frequency >= 410000000) &&
(RadioConfiguration.frequency <= 525000000)
)
{
RADIO_RegisterWrite(0x36, 0x02);
...
{
RADIO_RegisterWrite(0x3A, 0x65);
RADIO_RegisterWrite(0x3B, 25);
}
else
{
RADIO_RegisterWrite(0x3A, 0x65);
RADIO_RegisterWrite(0x3B, 29);
}
}
...
RADIO_RegisterWrite(0x25, RadioConfiguration.preambleLen >> (8));
RADIO_RegisterWrite(0x26, RadioConfiguration.preambleLen & 0xFF);


regValue = RADIO_RegisterRead(0x0A);
regValue &= ~0x60;
regValue |= RadioConfiguration.fskDataShaping << (5);
RADIO_RegisterWrite(0x0A, regValue);
...
RADIO_RegisterWrite(0x30, regValue);
...
RADIO_RegisterWrite(0x28 + i, RadioConfiguration.syncWord[i]);
}


if (RadioConfiguration.syncWordLen != 0)
{
RADIO_RegisterWrite(0x27, 0x10 | (RadioConfiguration.syncWordLen - 1));
}
else
{
RADIO_RegisterWrite(0x27, 0x00);
}


RADIO_RegisterWrite(0x3E, 0xFF);
RADIO_RegisterWrite(0x3F, 0xFF);
...
RadioError_t RADIO_TransmitCW(void)
{
if ((RadioConfiguration.flags & ((1 << (0)) | (1 << (1)))) != 0)
{
...
RadioConfiguration.flags |= (1 << (0));
RadioConfiguration.flags &= ~(1 << (4));
...
if ((RadioConfiguration.flags & (1 << (2))) != 0)
{
...
if (MODULATION_LORA == RadioConfiguration.modulation)
{
RADIO_RegisterWrite(0x22, bufferLen);
...
RADIO_RegisterWrite(0x40, 0x40);
RADIO_RegisterWrite(0x41, 0x00);
...
RADIO_RegisterWrite(0x00, bufferLen);
}

HALSPICSAssert();
HALSPISend(0x80 | 0x00);
...
RadioConfiguration.flags |= (1 << (0));
RadioConfiguration.flags &= ~((1 << (4)) | (1 << (3)));
...
SwTimerSetTimeout(RadioConfiguration.timeOnAirTimerId, ((((uint32_t)20000)) < 0x000FFFFFUL ? ( (((uint32_t)(((uint32_t)20000))) << (12)) / 125UL ) : ( (((uint32_t)(((uint32_t)20000))) / 125UL) << (12) ) ));
SwTimerStart(RadioConfiguration.timeOnAirTimerId);

if (0 != RadioConfiguration.watchdogTimerTimeout)
{
SwTimerSetTimeout(RadioConfiguration.watchdogTimerId, ((RadioConfiguration.watchdogTimerTimeout) < 0x000FFFFFUL ? ( (((uint32_t)(RadioConfiguration.watchdogTimerTimeout)) << (12)) / 125UL ) : ( (((uint32_t)(RadioConfiguration.watchdogTimerTimeout)) / 125UL) << (12) ) ));
...
{
RADIO_RegisterWrite(0x12, RadioConfiguration.rxBw);
RADIO_RegisterWrite(0x13, RadioConfiguration.afcBw);
...
SwTimerSetTimeout(RadioConfiguration.fskRxWindowTimerId, ( (((uint32_t)(rxWindowSize)) << (12)) / 125UL ));
...
void RADIO_ReceiveStop(void)
{
if ((1 << (1)) == RadioConfiguration.flags)
{
RADIO_WriteMode(MODE_SLEEP, RadioConfiguration.modulation, 0);
RadioConfiguration.flags &= ~(1 << (1));
}
...
{
uint8_t i, irqFlags;
irqFlags = RADIO_RegisterRead(0x12);


RADIO_RegisterWrite(0x12, (1<<(6)) | (1<<(5)) | (1<<(4)));
if (((1<<(6)) | (1<<(4))) == (irqFlags & ((1<<(6)) | (1<<(4)))))
{

SwTimerStop(RadioConfiguration.watchdogTimerId);


i = RADIO_RegisterRead(0x1C);
if ((0 == RadioConfiguration.crcOn) || ((0 == (irqFlags & (1<<(5)))) && (0 != (i & (1<<(6))))))
{

# 984
RadioConfiguration.dataBufferLen = RADIO_RegisterRead(0x13);
RADIO_RegisterWrite(0x0D, 0x00);
...
HALSPICSDeassert();
RadioConfiguration.flags |= (1 << (2));

RadioConfiguration.packetSNR = RADIO_RegisterRead(0x19);
RadioConfiguration.packetSNR /= (int8_t)4;
}
else
{

RadioConfiguration.flags |= (1 << (3));
}
RADIO_WriteMode(MODE_SLEEP, RadioConfiguration.modulation, 0);
RadioConfiguration.flags &= ~(1 << (1));
...
irqFlags = RADIO_RegisterRead(0x3F);
if ((1<<(2)) == (irqFlags & (1<<(2))))
{
...
SwTimerStop(RadioConfiguration.watchdogTimerId);
RADIO_RegisterWrite(0x12, 1<<(3));
RADIO_WriteMode(MODE_SLEEP, RadioConfiguration.modulation, 0);
RadioConfiguration.flags &= ~(1 << (0));
if ((RadioConfiguration.flags & (1 << (4))) == 0)
{
timeOnAir = ((uint32_t)20000) - ((SwTimerReadValue(RadioConfiguration.timeOnAirTimerId)) < 0x00DFAC1FUL ? ( (((uint32_t)(SwTimerReadValue(RadioConfiguration.timeOnAirTimerId))) * 125UL) >> (12) ) : ( (((uint32_t)(SwTimerReadValue(RadioConfiguration.timeOnAirTimerId))) >> (12)) * 125UL ) );
...
if ((0) != RadioConfiguration.frequencyHopPeriod)
{
if ((0) != RadioConfiguration.fhssNextFrequency)
{
...
uint8_t dioMapping;
uint8_t opMode;
dioMapping = (RADIO_RegisterRead(0x40) & 0xC0) >> (6);
opMode = RADIO_RegisterRead(0x01);
...
uint8_t dioMapping;
dioMapping = (RADIO_RegisterRead(0x40) & 0x30) >> (4);

if ((RADIO_RegisterRead(0x01) & 0x80) != 0)
{
...
uint8_t dioMapping;
uint8_t opMode;
dioMapping = (RADIO_RegisterRead(0x40) & 0x0C) >> (2);
opMode = RADIO_RegisterRead(0x01);
...
uint8_t dioMapping;
dioMapping = RADIO_RegisterRead(0x40) & 0x03;
...
uint8_t dioMapping;
dioMapping = (RADIO_RegisterRead(0x41) & 0xC0) >> (6);
...
uint8_t dioMapping;
dioMapping = (RADIO_RegisterRead(0x41) & 0x30) >> (4);
...
RADIO_WriteMode(MODE_SLEEP, MODULATION_LORA, 1);
RADIO_RegisterWrite(0x11, 0xFF);
RADIO_WriteMode(MODE_RXCONT, MODULATION_LORA, 1);
for (i = 0; i < 16; i++)
{
SystemBlockingWaitMs(1);
retVal <<= (1);
retVal |= RADIO_RegisterRead(0x2C) & 0x01;
}
...
{
uint8_t irqFlags;
irqFlags = RADIO_RegisterRead(0x3E);
if (0 == (irqFlags & (1<<(0))))
{
...
RADIO_WriteMode(MODE_SLEEP, RadioConfiguration.modulation, 0);
RadioConfiguration.flags |= (1 << (4));
if ((RadioConfiguration.flags & (1 << (1))) != 0)
{
RadioConfiguration.flags &= ~(1 << (1));
LORAWAN_RxTimeout();
}
else if ((RadioConfiguration.flags & (1 << (0))) != 0)
{
RadioConfiguration.flags &= ~(1 << (0));
...
(frequency >= 862000000) && (frequency <= 1020000000) )
{
RadioConfiguration.frequency = frequency;
return ERR_NONE;
}
