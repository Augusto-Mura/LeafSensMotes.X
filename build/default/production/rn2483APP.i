...
# 51 "mcc_generated_files/LoRaWAN/tmr_lora_addons.h"
...
# 47 "mcc_generated_files/LoRaWAN/lorawan_init.h"
...
switch(GPIO){
case 0x00:
mode? ANSELA |= 0x1 : ANSELA &= ~(0x1);
break;
case 0x01:
mode? ANSELA |= 0x2 : ANSELA &= ~(0x2);
break;
case 0x02:
mode? ANSELA |= 0x4 : ANSELA &= ~(0x4);
break;
case 0x03:
mode? ANSELA |= 0x8 : ANSELA &= ~(0x8);
break;
case 0x04:
mode? ANSELA |= 0x20 : ANSELA &= ~(0x20);
break;
case 0x05:
mode? ANSELE |= 0x1 : ANSELE &= ~(0x1);
break;
case 0x06:
mode? ANSELE |= 0x2 : ANSELE &= ~(0x2);
break;
case 0x16:
mode? ANSELD |= 0x4 : ANSELD &= ~(0x4);
break;
case 0x07:
mode? ANSELE |= 0x4 : ANSELE &= ~(0x4);
break;
case 0x11:
mode? ANSELC |= 0x20 : ANSELC &= ~(0x20);
break;
case 0x19:
mode? ANSELD |= 0x20 : ANSELD &= ~(0x20);
break;
}
}
...
switch(GPIO){
case 0x00:
mode? TRISA |= (0x1) : TRISA &= ~(0x1);
break;
case 0x01:
mode? TRISA |= (0x2) : TRISA &= ~(0x2);
break;
case 0x02:
mode? TRISA |= (0x4) : TRISA &= ~(0x4);
break;
case 0x03:
mode? TRISA |= (0x8) : TRISA &= ~(0x8);
break;
case 0xFF:
mode? TRISA |= (0x10) : TRISA &= ~(0x10);
break;
case 0x04:
mode? TRISA |= (0x20) : TRISA &= ~(0x20);
break;
case 0x05:
mode? TRISE |= (0x1) : TRISE &= ~(0x1);
break;
case 0x06:
mode? TRISE |= (0x2) : TRISE &= ~(0x2);
break;
case 0x16:
mode? TRISD |= (0x4) : TRISD &= ~(0x4);
break;
case 0x07:
mode? TRISE |= (0x4) : TRISE &= ~(0x4);
break;
case 0x11:
mode? TRISC |= (0x20) : TRISC &= ~(0x20);
break;
case 0x19:
mode? TRISD |= (0x20) : TRISD &= ~(0x20);
break;
}
}
...
switch(GPIO){
case 0x00:
digOut? LATA |= 0x1 : LATA &= ~0x1;
break;
case 0x01:
digOut? LATA |= 0x2 : LATA &= ~0x2;
break;
case 0x02:
digOut? LATA |= 0x4 : LATA &= ~0x4;
break;
case 0x03:
digOut? LATA |= 0x8 : LATA &= ~0x8;
break;
case 0xFF:
digOut? LATA |= 0x10 : LATA &= ~0x10;
break;
case 0x04:
digOut? LATA |= 0x20 : LATA &= ~0x20;
break;
case 0x05:
digOut? LATE |= 0x1 : LATE &= ~0x1;
break;
case 0x06:
digOut? LATE |= 0x2 : LATE &= ~0x2;
break;
case 0x16:
digOut? LATD |= 0x4 : LATD &= ~0x4;
break;
case 0x07:
digOut? LATE |= 0x4 : LATE &= ~0x4;
break;
case 0x11:
digOut? LATC |= 0x20 : LATC &= ~0x20;
break;
case 0x19:
digOut? LATD |= 0x20 : LATD &= ~0x20;
break;
}
}
...
switch(GPIO){
case 0x00:
return ((PORTA & 0x1) >> 0x0);
break;
case 0x01:
return ((PORTA & 0x2) >> 0x1);
break;
case 0x02:
return ((PORTA & 0x4) >> 0x2);
break;
case 0x03:
return ((PORTA & 0x8) >> 0x3);
break;
case 0xFF:
return ((PORTA & 0x10) >> 0x4);
break;
case 0x04:
return ((PORTA & 0x20) >> 0x5);
break;
case 0x05:
return ((PORTE & 0x1) >> 0x0);
break;
case 0x06:
return ((PORTE & 0x2) >> 0x1);
break;
case 0x16:
return ((PORTD & 0x4) >> 0x2);
break;
case 0x07:
return ((PORTE & 0x4) >> 0x2);
break;
case 0x11:
return ((PORTC & 0x20) >> 0x5);
break;
case 0x19:
return ((PORTD & 0x20) >> 0x5);
break;
}
}
...
GPIOAnalogMode(0x00, 0);
GPIOAnalogMode(0x01, 1);
GPIOAnalogMode(0x02, 1);
GPIOAnalogMode(0x03, 1);
GPIOAnalogMode(0xFF, 0);
GPIOAnalogMode(0x04, 0);
GPIOAnalogMode(0x05, 0);
GPIOAnalogMode(0x06, 0);
GPIOAnalogMode(0x16, 0);
GPIOAnalogMode(0x11, 0);
GPIOAnalogMode(0x19, 0);

GPIODigitalWrite(0x00, 0);
GPIODigitalWrite(0xFF, 0);
GPIODigitalWrite(0x04, 0);
...
for(int i=0; i<4; i++){
LORAWAN_SetChannelIdStatus(i, 0);
}

for(int i=0; i<4; i++){
LORAWAN_SetChannelIdStatus(i, 1);
}
