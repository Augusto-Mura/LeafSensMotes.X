...
# 1 "mcc_generated_files/LoRaWAN/tmr_lora_addons.c"
...
# 49 "mcc_generated_files/LoRaWAN/tmr_lora_addons.c"
...
void TMR_ISR_Lora_Init(void)
{
TMR1_SetInterruptHandler(TMR_ISR_lora);
}
...
if (ticksToScheduledInterrupt < ((uint32_t)0x10000))
{
reloadVal = ((uint32_t)0x10000) - ticksToScheduledInterrupt;
