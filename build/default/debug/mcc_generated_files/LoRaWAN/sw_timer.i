...
# 1 "mcc_generated_files/LoRaWAN/sw_timer.c"
...
# 110 "mcc_generated_files/LoRaWAN/../interrupt_manager.h"
...
# 94 "mcc_generated_files/LoRaWAN/../tmr5.h"
...
# 94 "mcc_generated_files/LoRaWAN/../tmr3.h"
...
# 95 "mcc_generated_files/LoRaWAN/../tmr1.h"
...
# 406 "mcc_generated_files/LoRaWAN/../ext_int.h"
...
# 72 "mcc_generated_files/LoRaWAN/../adc.h"
...
# 75 "mcc_generated_files/LoRaWAN/../eusart2.h"
typedef union {
struct {
unsigned perr : 1;
unsigned ferr : 1;
...
# 47 "mcc_generated_files/LoRaWAN/../LoRaWAN/lorawan_init.h"
...
# 60 "mcc_generated_files/LoRaWAN/../LoRaWAN/lorawan.h"
typedef enum
{
OK = 0,
NETWORK_NOT_JOINED ,
...
# 110 "mcc_generated_files/LoRaWAN/../LoRaWAN/lorawan_private.h"
typedef union
{
uint8_t value;
struct
...
# 58 "mcc_generated_files/LoRaWAN/../LoRaWAN/interrupt_manager_lora_addons.h"
...
# 55 "mcc_generated_files/LoRaWAN/../LoRaWAN/radio_driver_SX1276.h"
typedef enum
{
MODULATION_FSK = 0,
MODULATION_LORA,
...
# 55 "mcc_generated_files/LoRaWAN/../LoRaWAN/radio_driver_hal.h"
...
# 84 "mcc_generated_files/LoRaWAN/../mcc.h"
void SYSTEM_Initialize(void);

# 97
void OSCILLATOR_Initialize(void);

# 50 "mcc_generated_files/LoRaWAN/sw_timer.c"
typedef struct
{
...
volatile static SwTimer_t swTimers[20];
...
reloadVal = ((uint32_t)0x10000) - ticksRemaining;
...
tmrVal = TMR1_ReadTimer();

if (timerOverflow == 1)
{
timerOverflow = 0;
retVal = ((uint32_t)0x10000) - reloadVal + tmrVal - ticksAccounted + ticksAdded;
...
{
(INTCONbits.GIE = 0);
swTimers[timerId].ticksRemaining = timeout - 32;
(INTCONbits.GIE = 1);
}
...
swTimers[timerId].ticksRemaining = 0;
}

void SwClearAllTimers(void){
for (uint8_t i = 0; i < allocatedTimers; i++)
{
swTimers[i].ticksRemaining = 0;
}
}
